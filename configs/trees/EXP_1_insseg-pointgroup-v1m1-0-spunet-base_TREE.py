...
model = dict(
    ...
    instance_ignore_index=-1, #0, #-1,
    cluster_thresh=1, # 1 for NIBIO, SCION; 2 for CULS, RMIT; 3 for TUWIEN
    # cluster_thresh=1.5,
    # cluster_thresh=2,
    ...
    cluster_min_points=1000, # 1000 for NIBIO, SCION, CULS, TUWIEN; 100 for RMIT
    voxel_size=0.05,
)
